...
function tabframe_base:onDraw(allowPartial)
	...
	if not allowPartial or self.mCaptionUpdated then
		self:drawTabItems()
		self.mCaptionUpdated = false
	end
end
